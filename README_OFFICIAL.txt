...
v1.5.0 - 08/02/2016
- Fixed welcome email for new users, broken since WordPress 4.3
- Fixed password change email is no longer sent
- Fixed a warning when password is not specified in the imported CSV
...
v1.4.5 - 03/06/2013
- Fixed when user creation fails no proper error message appears
- Fixed Excel compatibility under PHP >= 5.1.0 (regressed in v1.4.0)

v1.4.4 - 30/10/2012
- Fixed (this time for real) an arbitrary file disclosure vulnerability (thanks to Charlie Eriksen via Secunia SVCRP)
  http://secunia.com/advisories/50834/
- Code cleanup

v1.4.3 - 29/10/2012
- Fixed (hopefully for real) an arbitrary file disclosure vulnerability (thanks to Charlie Eriksen via Secunia SVCRP)
  http://secunia.com/advisories/50834/
...
v1.4.1 - 23/07/2012
- Add nice name support (thanks to Chuck Scott for the patch)

v1.4.0 - 16/07/2012
- Fixed exporting should work much better for users with PHP >= v5.1.0 and delimiters exactly 1 character long
- Fixed creating new users with USER ID column absent was no longer possible (regressed in v1.3.0) (thanks to Greg C)
